...
def main():
    ...
    summary_template = """
        ...
        2. a list of 2 interesting facts
    """
    ...
    # Ollama models
    ollama_models = ["gemma3:270m", "gpt-oss:20b"]
    llm = ChatOllama(model=ollama_models[0], temperature=0) # 

    
    # this is a LCEL chain (LangChain Expression Language) -> it allows us to create chains of prompts and models and returns a runnable object
